...
\setlist[1]{leftmargin=0em, itemsep=0.4em, parsep=0em, topsep=0.25em, partopsep=0pt}
...
\begin{itemize}
  ...
  \item[] ``Mass Transport and Turbulence in Gravitationally Unstable Disk Galaxies. II:
    ...
    J.~C.\ 2015, {\it Astrophysical Journal}, submitted
  \item[] ``Mass Transport and Turbulence in Gravitationally Unstable Disk Galaxies. I:
    ...
    J.~C.\ 2015, {\it Astrophysical Journal}, 814, 131
